...
- Contract signing audit logs now record requester IP addresses, user agents, and the signing timestamp through the dedicated edge handler, keeping licensing flows compliant with audit requirements.【F:supabase/functions/contract-execution/handler.ts†L1-L160】【F:src/hooks/useContracts.tsx†L200-L248】
