...
- Contract signing audit logs now record requester IP addresses and user agents through the dedicated edge handler, keeping licensing flows compliant with audit requirements.【F:supabase/functions/contract-execution/handler.ts†L1-L133】【F:src/hooks/useContracts.tsx†L200-L248】
