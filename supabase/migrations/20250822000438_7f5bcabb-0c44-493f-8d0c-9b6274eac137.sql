...
-- Note: Using INSERT without ON CONFLICT since there's no unique constraint

-- First, clear any existing analytics data to avoid duplicates
DELETE FROM public.release_analytics;

-- Populate release_analytics with aggregated data from release_plays
