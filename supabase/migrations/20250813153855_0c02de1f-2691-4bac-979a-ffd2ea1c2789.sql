...
CREATE POLICY "Participants can view commission messages"
...
CREATE POLICY "Participants can insert commission messages"
ON public.commission_messages
FOR INSERT
WITH CHECK (
...
-- Policy: allow sender to delete their own messages
CREATE POLICY "Sender can delete own commission messages"
ON public.commission_messages
FOR DELETE
