-- Phase 1 & 2: Fix Critical RLS Recursion Issues and Security
...
-- Make mailing list properly admin-only
DROP POLICY IF EXISTS "Users can subscribe to mailing list" ON mailing_list;
