...
const styles = StyleSheet.create({
  ...
  backButton: { width: 44, height: 44, borderRadius: 5, backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', alignItems: 'center', justifyContent: 'center', marginBottom: 14 },
  ...
  emptyTitle: { color: '#FFFFFF', fontSize: 24, fontFamily: pluggdFonts.displayBold, fontWeight: '700' },
  emptyText: { color: '#B3B3B3', fontSize: 14, lineHeight: 21, textAlign: 'center', marginTop: 8 },
  hero: { height: 360, borderRadius: 6, overflow: 'hidden', backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', justifyContent: 'flex-end' },
  heroImage: { ...StyleSheet.absoluteFillObject, width: '100%', height: '100%' },
  heroCopy: { padding: 18 },
  eyebrow: { color: PLUGGD_ORANGE, fontSize: 12, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900', letterSpacing: 1.1 },
  title: { color: '#FFFFFF', fontSize: 34, lineHeight: 38, fontFamily: pluggdFonts.displayExtraBold, fontWeight: '800', marginTop: 5 },
  ...
  primaryButton: { flex: 1, height: 48, borderRadius: 5, backgroundColor: PLUGGD_ORANGE, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  primaryText: { color: '#0a0806', fontSize: 15, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  secondaryButton: { flex: 1, height: 48, borderRadius: 5, borderWidth: 1, borderColor: 'rgba(255,102,0,0.5)', backgroundColor: 'rgba(255,102,0,0.08)', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  secondaryText: { color: PLUGGD_ORANGE, fontSize: 15, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  iconButton: { width: 48, height: 48, borderRadius: 5, backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', alignItems: 'center', justifyContent: 'center' },
  sectionTitle: { color: '#FFFFFF', fontSize: 22, fontFamily: pluggdFonts.displayBold, fontWeight: '700', marginTop: 26, marginBottom: 12 },
  trackRow: { minHeight: 68, borderRadius: 5, backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', flexDirection: 'row', alignItems: 'center', gap: 11, padding: 10, marginBottom: 9 },
  trackIndex: { width: 22, color: '#737373', fontSize: 12, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900', textAlign: 'center' },
  trackArtwork: { width: 46, height: 46, borderRadius: 4, overflow: 'hidden', backgroundColor: '#241d15', alignItems: 'center', justifyContent: 'center' },
  ...
  emptyCard: { borderRadius: 5, backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', padding: 16 },
