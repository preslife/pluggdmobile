...
const styles = StyleSheet.create({
  ...
  heroCopy: { padding: 18 },
  eyebrow: { color: PLUGGD_ORANGE, fontSize: 12, fontWeight: '900', letterSpacing: 1.1 },
  title: { color: '#FFFFFF', fontSize: 34, lineHeight: 38, fontWeight: '900', marginTop: 5 },
  subtitle: { color: '#B3B3B3', fontSize: 14, fontWeight: '800', marginTop: 6 },
  description: { color: '#DADAE0', fontSize: 15, lineHeight: 22, fontWeight: '700', marginTop: 16 },
  ...
  primaryText: { color: '#08080C', fontSize: 15, fontWeight: '900' },
  ...
  secondaryText: { color: PLUGGD_ORANGE, fontSize: 15, fontWeight: '900' },
  ...
  sectionTitle: { color: '#FFFFFF', fontSize: 22, fontWeight: '900', marginTop: 26, marginBottom: 12 },
  ...
  trackIndex: { width: 22, color: '#737373', fontSize: 12, fontWeight: '900', textAlign: 'center' },
  ...
  trackTitle: { color: '#FFFFFF', fontSize: 15, fontWeight: '900' },
  trackMeta: { color: '#8E8E9F', fontSize: 12, fontWeight: '800', marginTop: 3 },
  ...
  emptyCardText: { color: '#B3B3B3', fontSize: 14, lineHeight: 20, fontWeight: '700' },
});
