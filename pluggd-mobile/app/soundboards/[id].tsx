...
const styles = StyleSheet.create({
  ...
  itemAction: { minHeight: 34, borderRadius: 17, borderWidth: 1, borderColor: 'rgba(255,102,0,0.28)', backgroundColor: 'rgba(255,102,0,0.08)', paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 5 },
