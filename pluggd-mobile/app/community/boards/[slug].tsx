...
const styles = StyleSheet.create({
  ...
  title: { color: COLORS.white, fontSize: 34, lineHeight: 39, fontWeight: '900' },
  description: { color: COLORS.soft, fontSize: 14, lineHeight: 21, fontWeight: '600' },
  ...
  metaText: { color: COLORS.muted, fontSize: 12, fontWeight: '900', textTransform: 'capitalize' },
  ...
  joinText: { color: COLORS.orange, fontSize: 13, fontWeight: '900' },
  ...
  threadButtonText: { color: COLORS.canvas, fontSize: 13, fontWeight: '900' },
  ...
  typeText: { color: COLORS.soft, fontSize: 12, fontWeight: '900' },
  ...
  composerPrompt: { flex: 1, color: COLORS.muted, fontSize: 13, lineHeight: 18, fontWeight: '700' },
