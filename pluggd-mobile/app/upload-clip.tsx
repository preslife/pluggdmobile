      ...
      <ScreenShell title="Creator Clips" subtitle="A release moment, built for discovery.">
        ...
        <View style={styles.accessHero}>
          <View style={styles.signalMark}>
            <MaterialIcons name="slow-motion-video" size={31} color={theme.colors.onAccent} />
          </View>
    ...
    <CreatorAccessGate>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel="Choose a video clip" style={styles.pickCard} onPress={pickClip}>
        <View style={[styles.mediaMark, clip && styles.mediaMarkSelected]}>
          <MaterialIcons name={clip ? 'movie' : 'add-photo-alternate'} size={30} color={clip ? theme.colors.onAccent : theme.colors.accentText} />
        </View>
      ...
      <View style={styles.reviewLedger}>
        <MaterialIcons name="verified-user" size={19} color={theme.colors.accentText} />
        <View style={styles.pickCopy}>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel={uploading ? 'Uploading clip' : 'Upload clip'} style={[styles.primaryButton, uploading && styles.disabledButton]} onPress={uploadClip} disabled={uploading}>
        {uploading ? <ActivityIndicator color={theme.colors.onAccent} /> : <Text style={styles.primaryButtonText}>Upload Clip</Text>}
      </Pressable>
...
function createStyles(theme: PluggdTheme) {
  ...
  signalMark: { width: 58, height: 58, borderRadius: 5, backgroundColor: theme.colors.accentFill, alignItems: 'center', justifyContent: 'center', marginBottom: 24 },
  accessKicker: { color: theme.colors.accentText, fontSize: 11, letterSpacing: 1.8, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  accessTitle: { color: theme.colors.text, fontSize: 35, lineHeight: 39, letterSpacing: -1.3, fontFamily: pluggdFonts.displayExtraBold, fontWeight: '800', marginTop: 8, maxWidth: 340 },
  accessBody: { color: theme.colors.textSecondary, fontSize: 14, lineHeight: 21, fontFamily: pluggdFonts.satoshiBold, fontWeight: '700', marginTop: 12, maxWidth: 335 },
  requirementLedger: { borderTopWidth: 1, borderBottomWidth: 1, borderColor: theme.colors.border },
  requirementRow: { minHeight: 78, flexDirection: 'row', gap: 15, alignItems: 'center', borderBottomWidth: 1, borderBottomColor: theme.colors.divider, paddingVertical: 13 },
  requirementRowLast: { borderBottomWidth: 0 },
  requirementIndex: { width: 28, color: theme.colors.accentText, fontSize: 11, letterSpacing: 1, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  requirementTitle: { color: theme.colors.text, fontSize: 15, fontFamily: pluggdFonts.displayBold, fontWeight: '700' },
  requirementBody: { color: theme.colors.textMuted, fontSize: 12.5, lineHeight: 18, fontFamily: pluggdFonts.satoshiBold, fontWeight: '700', marginTop: 3 },
  secondaryButton: { minHeight: 52, borderRadius: 5, borderWidth: 1, borderColor: theme.colors.controlBorder, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, marginTop: 10 },
  secondaryButtonText: { color: theme.colors.text, fontSize: 14, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  workflowLabel: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 4 },
  workflowIndex: { color: theme.colors.accentText, fontSize: 11, letterSpacing: 1.2, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  workflowTitle: { color: theme.colors.text, fontSize: 17, fontFamily: pluggdFonts.displayBold, fontWeight: '700' },
  workflowDetail: { marginLeft: 'auto', color: theme.colors.textMuted, fontSize: 10.5, fontFamily: pluggdFonts.satoshiBold, fontWeight: '700' },
  pickCard: { minHeight: 104, borderRadius: 5, borderWidth: 1, borderColor: theme.colors.controlBorder, backgroundColor: theme.colors.surface, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 18 },
  mediaMark: { width: 60, height: 60, borderRadius: 4, borderWidth: 1, borderStyle: 'dashed', borderColor: theme.colors.borderAccent, alignItems: 'center', justifyContent: 'center' },
  mediaMarkSelected: { backgroundColor: theme.colors.accentFill, borderStyle: 'solid', borderColor: theme.colors.accentFill },
  pickCopy: { flex: 1, minWidth: 0 },
  pickTitle: { color: theme.colors.text, fontSize: 16, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  pickBody: { color: theme.colors.textSecondary, fontSize: 12.5, fontFamily: pluggdFonts.satoshiBold, fontWeight: '700', marginTop: 5, lineHeight: 18 },
  caption: { minHeight: 116, borderRadius: 5, borderWidth: 1, borderColor: theme.colors.controlBorder, backgroundColor: theme.colors.surfaceRaised, color: theme.colors.text, padding: 14, fontSize: 14, fontFamily: pluggdFonts.satoshiBold, fontWeight: '700', textAlignVertical: 'top' },
  reviewLedger: { minHeight: 78, flexDirection: 'row', gap: 12, alignItems: 'flex-start', borderTopWidth: 1, borderBottomWidth: 1, borderColor: theme.colors.border, paddingVertical: 14, marginTop: 18 },
  reviewTitle: { color: theme.colors.text, fontSize: 13, fontFamily: pluggdFonts.displayBold, fontWeight: '700' },
  reviewBody: { color: theme.colors.textMuted, fontSize: 11.5, lineHeight: 17, fontFamily: pluggdFonts.satoshiBold, fontWeight: '700', marginTop: 3 },
  primaryButton: { minHeight: 52, borderRadius: 5, backgroundColor: theme.colors.accentFill, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 18, marginTop: 18 },
  primaryButtonText: { color: theme.colors.onAccent, fontSize: 14, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
