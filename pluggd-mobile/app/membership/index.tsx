...
const styles = StyleSheet.create({
  ...
  signedOutTitle: { fontSize: 24, lineHeight: 29, fontWeight: '900', textAlign: 'center' },
  signedOutBody: { fontSize: 14, lineHeight: 20, fontWeight: '700', textAlign: 'center' },
  ...
  heroTitle: { fontSize: 34, lineHeight: 37, fontWeight: '900', letterSpacing: 0 },
  heroBody: { fontSize: 15, lineHeight: 21, fontWeight: '700' },
  ...
  statLabel: { marginTop: 1, fontSize: 11, lineHeight: 14, fontWeight: '900', textTransform: 'uppercase' },
  ...
  primaryButtonText: { color: '#08080C', fontSize: 15, fontWeight: '900' },
  ...
  section: { gap: 11 },
  sectionHead: { gap: 4 },
  sectionTitle: { fontSize: 23, lineHeight: 27, fontWeight: '900' },
  sectionSubtitle: { fontSize: 13, lineHeight: 18, fontWeight: '700' },
  ...
  emptyTitle: { fontSize: 19, lineHeight: 23, fontWeight: '900' },
  emptyBody: { fontSize: 13, lineHeight: 19, fontWeight: '700' },
  ...
  tierBadge: { overflow: 'hidden', borderRadius: 999, borderWidth: 1, paddingHorizontal: 8, paddingVertical: 3, fontSize: 10, lineHeight: 12, fontWeight: '900', textTransform: 'uppercase' },
  statusDot: { width: 7, height: 7, borderRadius: 999 },
  membershipStatus: { fontSize: 11, lineHeight: 14, fontWeight: '800', textTransform: 'capitalize' },
  membershipRenewal: { fontSize: 12, lineHeight: 16, fontWeight: '700' },
  ...
  tierTitle: { fontSize: 17, lineHeight: 20, fontWeight: '900' },
  tierPrice: { fontSize: 14, lineHeight: 17, fontWeight: '900' },
  tierCaption: { fontSize: 11, lineHeight: 14, fontWeight: '700' },
  ...
  reviewTitle: { fontSize: 15, lineHeight: 18, fontWeight: '900' },
  reviewBody: { fontSize: 12, lineHeight: 17, fontWeight: '700' },
});
