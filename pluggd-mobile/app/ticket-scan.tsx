...
const styles = StyleSheet.create({
  ...
  scanHint: { position: 'absolute', bottom: 18, color: '#FFFFFF', fontSize: 12, fontWeight: '900', letterSpacing: 0.4, textTransform: 'uppercase' },
  ...
  permissionTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '900', marginTop: 12 },
  permissionText: { color: '#B3B3B3', fontSize: 13, fontWeight: '700', textAlign: 'center', lineHeight: 19, marginTop: 8 },
  ...
  permissionButtonText: { color: '#08080C', fontSize: 13, fontWeight: '900' },
  ...
  input: { minHeight: 54, borderRadius: 12, borderWidth: 1, borderColor: '#262626', backgroundColor: '#08080C', color: '#FFFFFF', paddingHorizontal: 12, fontSize: 14, fontWeight: '700' },
  lookupButton: { height: 48, borderRadius: 24, backgroundColor: PLUGGD_ORANGE, alignItems: 'center', justifyContent: 'center' },
  lookupText: { color: '#08080C', fontSize: 14, fontWeight: '900' },
  ...
  resultMeta: { color: '#B3B3B3', fontSize: 12, fontWeight: '700', marginTop: 4 },
  ...
  detailLabel: { color: '#737373', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  detailValue: { color: '#FFFFFF', fontSize: 13, fontWeight: '900', marginTop: 5, textTransform: 'capitalize' },
  payload: { color: '#8E8E9F', fontSize: 11, fontWeight: '700', lineHeight: 16 },
