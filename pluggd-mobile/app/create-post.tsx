...
const styles = StyleSheet.create({
  ...
  titleInput: { minHeight: 48, borderRadius: 5, backgroundColor: '#111116', borderWidth: 1, borderColor: '#2a221a', color: '#FFFFFF', paddingHorizontal: 13, fontFamily: 'Satoshi-Bold', fontSize: 15 },
