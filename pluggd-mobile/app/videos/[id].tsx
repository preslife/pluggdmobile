...
const styles = StyleSheet.create({
  ...
  hero: { height: 430, borderRadius: 6, overflow: 'hidden', backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', justifyContent: 'flex-end' },
  ...
  heroCopy: { padding: 18 },
  eyebrow: { color: ORANGE, fontFamily: pluggdFonts.satoshiBlack, fontSize: 12, letterSpacing: 1.1 },
  ...
  primaryButton: { flex: 1, minHeight: 50, borderRadius: 5, backgroundColor: ORANGE, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  primaryText: { color: '#0a0806', fontFamily: pluggdFonts.satoshiBlack, fontSize: 15 },
  secondaryButton: { minWidth: 128, minHeight: 50, borderRadius: 5, backgroundColor: '#171310', borderWidth: 1, borderColor: '#262626', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  secondaryText: { color: '#FFFFFF', fontFamily: pluggdFonts.satoshiBold, fontSize: 14 },
});
