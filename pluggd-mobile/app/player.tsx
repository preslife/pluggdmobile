...
const styles = StyleSheet.create({
  ...
  topTitle: { color: '#FFFFFF', fontSize: 12, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900', textTransform: 'uppercase' },
  ...
  timeText: { color: '#737373', fontSize: 12, fontFamily: pluggdFonts.satoshiBold, fontWeight: '800', fontVariant: ['tabular-nums'] },
  ...
  infoTitle: { color: '#FFFFFF', fontSize: 18, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900', marginBottom: 7 },
