...
const styles = StyleSheet.create({
  ...
  stepRail: { gap: 8, paddingRight: 16 },
  step: { minWidth: 108, height: 44, borderRadius: 14, borderWidth: 1, borderColor: LINE, backgroundColor: PANEL, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 7 },
