...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 33, lineHeight: 36, fontWeight: '900', letterSpacing: 0 },
  ...
  ticketTitle: { fontSize: 16, lineHeight: 21, fontWeight: '900' },
  ticketMeta: { fontSize: 12.5, fontWeight: '700', marginTop: 4 },
  ...
  qrLabel: { fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  qrCodeBox: { alignSelf: 'center', borderRadius: 18, backgroundColor: '#FFFFFF', padding: 12, marginTop: 10 },
  qrValue: { fontSize: 12, fontWeight: '800', marginTop: 4 },
  qrExpiry: { fontSize: 11, fontWeight: '700', marginTop: 4 },
  ...
  infoTitle: { fontSize: 15, lineHeight: 18, fontWeight: '900' },
  infoBody: { fontSize: 12, lineHeight: 17, fontWeight: '700' },
});
