...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#B8B8B8', fontSize: 16, fontWeight: '800', marginTop: 5 },
  ...
  metaValue: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', marginTop: 5 },
  ...
  secondaryButtonText: { color: PLUGGD_ORANGE, fontSize: 15, fontWeight: '900' },
  ...
  liveTitle: { color: '#FFFFFF', fontSize: 16, fontWeight: '900' },
