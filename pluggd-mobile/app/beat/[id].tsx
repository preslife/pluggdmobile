...
const styles = StyleSheet.create({
  ...
  metaCard: { flex: 1, borderRadius: 14, borderWidth: 1, borderColor: '#262626', backgroundColor: '#171310', padding: 12 },
  ...
  quickActionButton: { minHeight: 40, flexGrow: 1, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,102,0,0.32)', backgroundColor: 'rgba(255,102,0,0.08)', paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  quickActionText: { color: PLUGGD_ORANGE, fontSize: 12, fontFamily: pluggdFonts.satoshiBlack, fontWeight: '900' },
  licenseCard: { marginTop: 16, borderRadius: 16, borderWidth: 1, borderColor: '#262626', backgroundColor: '#171310', padding: 14 },
  ...
  licenseRow: { minHeight: 42, borderRadius: 12, borderWidth: 1, borderColor: '#262626', backgroundColor: '#241d15', paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
