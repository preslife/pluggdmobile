...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#B8B8B8', fontSize: 17, fontWeight: '700', marginTop: 5 },
  ...
  metaLabel: { color: '#8E8E8E', fontSize: 11, fontWeight: '800', textTransform: 'uppercase' },
  metaValue: { color: '#FFFFFF', fontSize: 16, fontWeight: '800', marginTop: 5 },
  ...
  cardTitle: { color: '#FFFFFF', fontSize: 19, fontWeight: '800' },
