  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <BrandLogo width={medium ? 76 : 88} height={23} />
        </Pressable>
            ...
            return (
              ...
              >
                <MaterialIcons
                  name={item.icon}
                  size={18}
                  color={active ? liquidGlassColors.textPrimary : liquidGlassColors.textMuted}
                />
                <Text
                  ...
                  numberOfLines={1}
                  style={[styles.tabLabel, medium && styles.tabLabelMedium, active && styles.tabLabelActive]}
                >
                  {item.label}
                </Text>
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  tabActive: {
    ...
    borderColor: 'rgba(255,153,82,0.28)',
  },
  tabPressed: {
    opacity: 0.82,
