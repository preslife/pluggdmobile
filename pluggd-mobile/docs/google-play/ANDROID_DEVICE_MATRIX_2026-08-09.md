...
| 36 | Pixel 9, Google APIs ARM64 | 1,258 ms | Automated smoke plus edge-back gesture; release manifest has `enableOnBackInvokedCallback=true`, gesture returned to Launcher without a fatal log | PASS — [Discover](../../artifacts/qa/android-v1-2026-08-08/api36-discover-current-release.png) |

The current app source therefore has release-APK launch coverage at every
planned emulator OS gate: 24, 33, 35, and 36. Previous exact-release API 36
...
physical devices. Minimum-OS playback also remains open even though install,
auth rendering, Discover stress, Home navigation, and native linkage passed.
