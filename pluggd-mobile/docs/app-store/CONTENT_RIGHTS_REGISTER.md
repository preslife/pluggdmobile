...
| Build 8 app icon | Founder-supplied generated artwork, approved in the 26 August 2026 Build 8 review and stored as `pluggd-mobile/assets/icon.png` | Conditional | Conditional | Retain the original generation/source record and record ROWSON GROUP LTD's confirmation that it may be used in the product and App Store materials. |
| Other splash art | `pluggd-mobile/assets/` | Pending owner confirmation | Pending owner confirmation | Record designer/source and assignment to PLUGGD or exclude it from submission assets. |
...
| Final Build 8 screenshot and walkthrough media set | Not selected yet | Pending | Pending | Freeze the exact final files, list every visible media/identity item here, link the underlying authority and obtain legal/Account Holder confirmation before signing the Build 8 statement. |
