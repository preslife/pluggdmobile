...
const styles = StyleSheet.create({
  ...
  fallbackInitials: { fontFamily: pluggdFonts.satoshiBlack, color: 'rgba(255,255,255,0.84)', fontSize: 28, lineHeight: 34, fontWeight: '900' },
  ...
  eventHubMeta: { fontFamily: pluggdFonts.satoshiBold, marginTop: 4, color: COLORS.muted, fontSize: 15, lineHeight: 18, fontWeight: '700' },
  eventCountdown: { fontFamily: pluggdFonts.satoshiBlack, marginTop: 7, color: COLORS.white, fontSize: 24, lineHeight: 28, fontWeight: '900', fontVariant: ['tabular-nums'] },
  ...
  producerSubtitle: { fontFamily: pluggdFonts.satoshiMedium, marginTop: 4, color: COLORS.muted, fontSize: 12, lineHeight: 16, fontWeight: '600' },
  ...
  challengeBody: { fontFamily: pluggdFonts.satoshiMedium, marginTop: 6, color: COLORS.muted, fontSize: 12, lineHeight: 17, fontWeight: '600' },
