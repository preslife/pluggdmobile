...
export const WEB_PARITY_ASSETS: Record<WebParityAssetKey, ImageSourcePropType> = {
  ...
  liveHero: require('../../../assets/web-parity/live/pluggd-live-hero.jpg'),
  eventsHero: require('../../../assets/web-parity/events/pluggd-events.jpg'),
  mixesHero: require('../../../assets/web-parity/discover/pluggd-mixes.jpg'),
