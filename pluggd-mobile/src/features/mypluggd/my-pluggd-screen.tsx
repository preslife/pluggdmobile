...
const styles = StyleSheet.create({
  ...
  menuTitle: { fontFamily: 'PluggdSans5-Regular', fontSize: 28, lineHeight: 32, paddingHorizontal: 8, paddingVertical: 10 },
  ...
  mapTitle: { fontFamily: 'PluggdSans5-Regular', fontSize: 32, lineHeight: 36 },
  ...
  mapWatermark: { position: 'absolute', left: 16, top: 16, color: 'rgba(255,255,255,0.16)', fontFamily: 'PluggdSans5-Regular', fontSize: 30 },
