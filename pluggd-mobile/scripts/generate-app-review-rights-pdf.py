...
OUTPUT = ROOT / "output" / "pdf" / "PLUGGD_Content_Rights_Statement_Build7.pdf"
...
def build() -> None:
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=19 * mm,
        bottomMargin=18 * mm,
        title="PLUGGD Content Rights and Safety Statement - Build 7",
        author="ROWSON GROUP LTD",
        subject="App Review supporting statement for PLUGGD iOS 1.0.0 (7)",
    )
    ...
    story = [
        ...
        Paragraph(
            "PLUGGD iOS 1.0.0 (Build 7) &nbsp;&nbsp;|&nbsp;&nbsp; App Store Connect ID 6765738727 &nbsp;&nbsp;|&nbsp;&nbsp; Prepared 15 August 2026",
            meta,
        ),
        ...
        Paragraph(
            "The audio and artwork used in Build 7 review flows and App Store screenshots is controlled by PLUGGD or supplied by creators who authorized its use. Imported third-party catalogue records are metadata only: they receive no playable URL, cannot enter the native player or queue, and are not sold as PLUGGD audio.",
            body,
        ),
    ...
    signature_data = [
        [Paragraph("Signed for ROWSON GROUP LTD, App Store publisher of PLUGGD", heading), ""],
        [Paragraph("Name", small), Paragraph("Role", small)],
        [Paragraph("Ishola Pedro", body), Paragraph("Authorised Signatory", body)],
        [Paragraph("Signature", small), Paragraph("Date", small)],
        ["", Paragraph("15 August 2026", body)],
    ]
    ...
    def decorate(canvas, _doc):
        ...
        canvas.drawRightString(width - 22 * mm, 14 * mm, "PLUGGD iOS BUILD 7 - APP REVIEW")
        canvas.restoreState()
