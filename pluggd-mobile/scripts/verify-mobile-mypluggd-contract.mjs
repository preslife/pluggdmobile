...
assert.match(studioScreens, /<Text style=\{[^}]*styles\.studioBrandTitle[^}]*\} numberOfLines=\{1\}>STUDIO<\/Text>/, 'Studio topbar must stay branded as STUDIO while allowing resolved-theme text colour');
